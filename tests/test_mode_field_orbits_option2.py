...
class test_mode_logic(MpfGameTestCase):
    ...
    def test_mode_start_logic(self):
        ...
        self.mock_event("enable_sh_orbit_lane_left_opt2")
        self.mock_event("enable_sh_orbit_lane_right_opt2")
        self.mock_event("enable_sh_orbit_lane_center_opt2")
        ...
        # Transition manually to mode option2
        self.post_event("ce_change_field_orbits_to_option2")
        self.advance_time_and_run(1)
        self.assertModeRunning("field_orbits_option2")
        self.assertModeNotRunning("field_orbits_option1")
        ...
        self.assertEventCalled("enable_sh_orbit_lane_left_opt2")
        self.assertEventCalled("enable_sh_orbit_lane_right_opt2")
        self.assertEventCalled("enable_sh_orbit_lane_center_opt2")
        ...
        self.assertTrue(self.machine.shots["sh_orbit_lane_left_opt2"].enabled)
        self.assertTrue(self.machine.shots["sh_orbit_lane_right_opt2"].enabled)
        self.assertTrue(self.machine.shots["sh_orbit_lane_center_opt2"].enabled)
    ...
    def test_orbit_left_long_hit(self):
        ...
        self.mock_event("sq_shot_orbit_left_long_opt2_hit")
        self.hit_and_release_switch("s_orbit_right")
        self.advance_time_and_run(0.1)
        self.assertEventCalled("sq_shot_orbit_left_long_opt2_hit")
        self.reset_mock_events()
    ...
    def test_orbit_left_long_hit_lanes(self):
        ...
        self.assertTrue(self.machine.shots["sh_orbit_lane_left_opt2"].enabled)
        self.assertFalse(self.machine.shots["sh_orbit_lane_right_opt2"].enabled)
        self.assertFalse(self.machine.shots["sh_orbit_lane_center_opt2"].enabled)
    ...
    def test_orbit_left_long_hit_diverters(self):
        ...
        self.mock_event("mode_field_orbits_option2_started")
    ...
    def test_orbit_left_long_timeout(self):
        ...
        self.mock_event("sq_shot_orbit_left_long_opt2_timeout")
        self.advance_time_and_run(2)
        self.assertEventCalled("sq_shot_orbit_left_long_opt2_timeout")
        self.reset_mock_events()
    ...
    def test_orbit_right_short_hit(self):
        ...
        self.mock_event("sq_shot_orbit_right_short_opt2_hit")
        self.hit_and_release_switch("s_spinner_short_orbit")
        self.advance_time_and_run(0.1)
        self.assertEventCalled("sq_shot_orbit_right_short_opt2_hit")
        self.reset_mock_events()
    ...
    def test_orbit_right_short_hit_lanes(self):
        ...
        # Other lanes shots will be disabled
        self.assertFalse(self.machine.shots["sh_orbit_lane_left_opt2"].enabled)
        self.assertTrue(self.machine.shots["sh_orbit_lane_right_opt2"].enabled)
        self.assertFalse(self.machine.shots["sh_orbit_lane_center_opt2"].enabled)
    ...
    def test_orbit_right_short_hit_diverters(self):
        ...
        # Diverter forest still deactive
        self.assertEqual(True, self.machine.diverters.div_castle.enabled)
        self.assertEqual(True, self.machine.diverters.div_forest.enabled)
        self.assertEqual(False, self.machine.diverters.div_castle.active)
        self.assertEqual(False, self.machine.diverters.div_forest.active)
        ...
        self.mock_event("deactivate_div_castle")
        self.advance_time_and_run(1)
        self.assertEventNotCalled("deactivate_div_castle")
        self.reset_mock_events()
        ...
        # Hit s_spinner_short_orbit switch to complete right_orbit_big sequence before sequence time-out is reached
        self.hit_and_release_switch("s_spinner_short_orbit")
        self.advance_time_and_run(0.1)
    ...
    def test_orbit_right_short_timeout(self):
        ...
        # Advance for another two seconds to test sequence time-out (3 seconds after lane shot is hit)
        self.mock_event("sq_shot_orbit_right_short_opt2_timeout")
        self.advance_time_and_run(2)
        self.assertEventCalled("sq_shot_orbit_right_short_opt2_timeout")
        self.reset_mock_events()
    ...
    def test_orbit_right_short_timeout_diverters(self):
        ...
        # Diverter forest still deactive and diverter castle will be deactive
        self.assertEqual(True, self.machine.diverters.div_castle.enabled)
        self.assertEqual(True, self.machine.diverters.div_forest.enabled)
        self.assertEqual(False, self.machine.diverters.div_castle.active)
        self.assertEqual(False, self.machine.diverters.div_forest.active)
    ...
    def test_orbit_center_short_hit(self):
        ...
        self.mock_event("sq_shot_orbit_center_short_opt2_hit")
        self.hit_and_release_switch("s_orbit_right")
        self.advance_time_and_run(0.1)
        self.assertEventCalled("sq_shot_orbit_center_short_opt2_hit")
        self.reset_mock_events()
    ...
    def test_orbit_center_short_timeout(self):
        ...
        # Advance for another two seconds to test sequence time-out (3 seconds after lane shot is hit)
        self.mock_event("sq_shot_orbit_center_short_opt2_timeout")
        self.advance_time_and_run(2)
        self.assertEventCalled("sq_shot_orbit_center_short_opt2_timeout")
        self.reset_mock_events()
