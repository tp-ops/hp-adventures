...
class test_mode_logic(MpfGameTestCase):
    ...
    def test_mode_start_logic(self):
        ...
        self.mock_event("enable_sh_orbit_lane_right_opt3")
        ...
        self.assertEventCalled("enable_sh_orbit_lane_right_opt3")
        self.assertEventCalled("enable_sh_orbit_lane_center_opt3")
        ...
        self.assertTrue(self.machine.shots["sh_orbit_lane_right_opt3"].enabled)
        self.assertTrue(self.machine.shots["sh_orbit_lane_center_opt3"].enabled)
    ...
    def test_orbit_right_short_hit(self):
        ...
        self.mock_event("sq_shot_orbit_right_short_opt3_hit")
        self.hit_and_release_switch("s_spinner_short_orbit")
        self.advance_time_and_run(0.1)
        self.assertEventCalled("sq_shot_orbit_right_short_opt3_hit")
        self.reset_mock_events()
    ...
    def test_orbit_right_short_hit_lanes(self):
        ...
        self.assertTrue(self.machine.shots["sh_orbit_lane_right_opt3"].enabled)
        self.assertFalse(self.machine.shots["sh_orbit_lane_center_opt3"].enabled)

        # Advance for another second and diverter should be disactivated (2 seconds after lane shot is hit)
        self.advance_time_and_run(1)
  
        # Hit s_spinner_short_orbit switch to complete orbit_right_short sequence before sequence time-out is reached
        self.hit_and_release_switch("s_spinner_short_orbit")
        self.advance_time_and_run(0.1)
    ...
    def test_orbit_right_short_timeout(self):
        ...
        self.mock_event("sq_shot_orbit_right_short_opt3_timeout")
        self.advance_time_and_run(2)
        self.assertEventCalled("sq_shot_orbit_right_short_opt3_timeout")
        self.reset_mock_events()
    ...
    def test_orbit_center_short_hit(self):
        ...
        self.mock_event("sq_shot_orbit_center_short_opt3_hit")
        self.hit_and_release_switch("s_orbit_right")
        self.advance_time_and_run(0.1)
        self.assertEventCalled("sq_shot_orbit_center_short_opt3_hit")
        self.reset_mock_events()
    ...
    def test_orbit_center_short_hit_lanes(self):
        ...
        # Other lanes shots will be disabled
        self.assertFalse(self.machine.shots["sh_orbit_lane_right_opt3"].enabled)
        self.assertTrue(self.machine.shots["sh_orbit_lane_center_opt3"].enabled)
    ...
    def test_orbit_center_short_timeout(self):
        ...
        # Advance for another two seconds to test sequence time-out (3 seconds after lane shot is hit)
        self.mock_event("sq_shot_orbit_center_short_opt3_timeout")
        self.advance_time_and_run(2)
        self.assertEventCalled("sq_shot_orbit_center_short_opt3_timeout")
        self.reset_mock_events()
